...
{
    public partial class UC_C_Order : UserControl
    {
        ...
        private void UC_C_Order_Load(object sender, EventArgs e)
        {
        ...
        {
            MessageBox.Show("Payment is done", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
        }
